...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien___0{n}.png'), 0, 0.25) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien___1{n}.png'), 0, 0.25) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien___2{n}.png'), 0, 0.25) for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/ufo___{n}.png'), 0, 0.7) for n in range(2)]
