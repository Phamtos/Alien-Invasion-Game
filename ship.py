...
class Ship(Sprite):
  exploding_images = [pg.image.load(f'images/explosion{n}.png') for n in range(10)]
  images = [pg.image.load(f'images/rocket.bmp') for n in range(1)]
  ...
  def __init__(self, game):
    ...
    self.image = pg.image.load('images/rocket.bmp')
